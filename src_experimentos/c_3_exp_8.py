...
def lanzar_experimento_lgbm(fecha:str ,semillas:list[int],n_experimento:int,proceso_ppal:str ="experimento"): 
    ...
    df_completo_chiquito=creacion_df_small("df_completo")
    cols_drops_2=cols_a_dropear_variable_entera(df_completo_chiquito, ['mprestamos_personales','cprestamos_personales','suma_de_prestamos_productos'])
    
    df_completo_chiquito=creacion_df_small("df_completo")
    cols_drops_3=cols_a_dropear_variable_originales_o_percentiles(df_completo_chiquito,a_eliminar="originales")
...
## 5. Primer Entrenamiento lgbm con la mejor iteracion y los mejores hiperparametros en [01,02,03] y evaluamos en 04 
    ...
    if (proceso_ppal =="experimento" or proceso_ppal =="test_exp") :
        ...
        for mt in mes_test:
            ...
            X_train, _,y_train_binaria,y_train_class, w_train, X_test, _,y_test_binaria, y_test_class, w_test,_, _ = split_train_test_apred(n_experimento,mes_train,
                                                                                                                                        mt,MES_A_PREDECIR,
        ...
        X_train, _,y_train_binaria,y_train_class, w_train, _, _,_, _, _,X_apred, y_apred = split_train_test_apred(n_experimento,mes_train,
